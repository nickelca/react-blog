        ...
        <div className='page'>
            ...
            <div className='content'>
                ...
                <div id="blog-container">
                    <Image id="floated" className='May-18-2024-img1' src="../../../../public/IMG_1554.png" />
                    <p>Yesterday, I drove up to Oshkosh all the way from Milwaukee with my uncle and cousins
                        ...
                        small plane built out of fiberglass at the EAA called a GlaStar. We were 600 feet in the air when
                        the pilot let me steer the plane around!
                    </p>
                    <Image className='May-18-2024-img2' src="../../../../public/IMG_1555.png" />
                </div>
            </div>
